...
export function LuminaHero() {
  ...
  return (
    <>
      <style jsx global>{`
        .slider-wrapper { position: relative; width: 100%; height: 100vh; overflow: hidden; background: #000; }
        ...
        .slide-nav-title { font-family: var(--font-mono); font-size: 0.7rem; text-transform: uppercase; letter-spacing: 0.1em; }
        .slide-progress-line { width: 40px; height: 1px; background: rgba(255,255,255,0.3); position: relative; }
        .slide-progress-fill { height: 100%; background: #fff; width: 0%; position: absolute; left: 0; top: 0; }
        
        .slide-number { position: absolute; top: 120px; left: 5%; font-family: var(--font-mono); font-size: 0.8rem; color: rgba(255,255,255,0.5); z-index: 10; }
        .slide-total { position: absolute; top: 120px; left: 8%; font-family: var(--font-mono); font-size: 0.8rem; color: rgba(255,255,255,0.2); z-index: 10; }
        .slide-total::before { content: "/"; margin-right: 5px; }
